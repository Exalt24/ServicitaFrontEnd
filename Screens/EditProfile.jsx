...
const fetchCities = async () => {
  try {
    const response = await axios.get('http://172.16.1.176:5000/location/getCities');
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      ...
      if (compareImage !== userData.profileImage) {
        ...
        await axios.patch('http://172.16.1.176:5000/user/updateImage', { userId: userData._id, url: url });
      }
