...
const AIScreen = ({ navigation, route }) => {
  ...
  const submitHandler = async () => {
    ...
    try {
      ...
      const response =
        userRole === "Seeker"
          ? await axios.post("http://192.168.254.111:5000/ai/generateSeekerContent", { inputText: inputMessage })
          : await axios.post("http://192.168.254.111:5000/ai/generateProviderContent", { inputText: inputMessage });
