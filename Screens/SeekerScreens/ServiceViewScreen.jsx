...
export default ServiceViewScreen = ({navigation, route}) => {
  ...
  async function getMessageNeededData () {
    const resultSeeker = await axios.post("http://172.16.1.176:5000/user/getUserDetailsById", { id: userData._id });
    ...
    const resultProvider = await axios.post("http://172.16.1.176:5000/user/getUserDetailsById", { id: data.providerId });
