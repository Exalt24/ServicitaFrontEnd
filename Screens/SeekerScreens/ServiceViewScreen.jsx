...
export default ServiceViewScreen = ({navigation, route}) => {
  ...
  async function getMessageNeededData () {
    const resultSeeker = await axios.post("http://3.107.4.155:5001/user/getUserDetailsById", { id: userData._id });
    ...
    const resultProvider = await axios.post("http://3.107.4.155:5001/user/getUserDetailsById", { id: data.providerId });
