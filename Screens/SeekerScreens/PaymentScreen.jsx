  ...
  // };
    ...
    const handleContinue = async () => {
      ...
      const paymentData = {
        ...
        redirect: {
          success: "http://192.168.1.2:5000/payment/success",
          failed: "http://192.168.1.2:5000/payment/failed",
        }
      }
      try {
        const response = await axios.post('http://192.168.1.2:5000/payment/initiatePayment', paymentData);
