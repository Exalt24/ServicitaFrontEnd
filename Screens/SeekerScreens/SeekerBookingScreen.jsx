...
export default function SeekerBookingScreen({ navigation, route }) {
  ...
  const getUserIdAndImage = async () => {
    try {
      const result = await axios.post("http://172.16.4.69:5000/user/getUserDetailsByEmail", { email: userEmail })
  ...
  async function getBookingData() {
    try {
        ...
        for (const doc of snapshot.docs) {
            ...
            const result = await axios.post("http://172.16.4.69:5000/user/getUserDetailsById", { id: providerSnapshot.id })
