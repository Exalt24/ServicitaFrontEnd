...
<<<<<<< HEAD
                          axios.get(`http://172.16.9.33:5000/admin/checkSuspensionStatus/${userEmail}`).then((res) => {
=======
                          axios.get(`http://172.16.4.69:5000/admin/checkSuspensionStatus/${userEmail}`).then((res) => {
>>>>>>> f23b0e0 (Homepage_v1)
                            if (res.data.status === 'SUCCESS') {
                              ...
                              if (res.data.type === 'SUSPENDED') {
                                ...
                                if (remainingTime <= 0) {
<<<<<<< HEAD
                                  axios.patch(`http://172.16.9.33:5000/admin/unsuspendUser`, { email: userData.email }).then((res) => {
                                    if (res.data.status === 'SUCCESS') {
                                      axios.post("http://172.16.9.33:5000/user/loginOther", {email: userData.email }).then((res) => {
=======
                                  axios.patch(`http://172.16.4.69:5000/admin/unsuspendUser`, { email: userData.email }).then((res) => {
                                    if (res.data.status === 'SUCCESS') {
                                      axios.post("http://172.16.4.69:5000/user/loginOther", {email: userData.email }).then((res) => {
>>>>>>> f23b0e0 (Homepage_v1)
...
<<<<<<< HEAD
                                axios.post("http://172.16.9.33:5000/user/loginOther", userEmail).then((res) => {
=======
                                axios.post("http://172.16.4.69:5000/user/loginOther", userEmail).then((res) => {
>>>>>>> f23b0e0 (Homepage_v1)
                                    console.log(res.data)
                                    if (res.data.status === 'SUCCESS') {
                                        Alert.alert('Success', 'You have successfully logged in.', [{ text: 'OK' }]);
    ...
    const GoogleSignIn = async () => {
        try {
          ...
          if (emailExists.exists) {
            ...
            if (emailExists.type === "permanent") {
<<<<<<< HEAD
              axios.get(`http://172.16.9.33:5000/admin/checkSuspensionStatus/${userData.email}`).then((res) => {
=======
              axios.get(`http://172.16.4.69:5000/admin/checkSuspensionStatus/${userData.email}`).then((res) => {
>>>>>>> f23b0e0 (Homepage_v1)
                if (res.data.status === 'SUCCESS') {
                  if (res.data.type === 'SUSPENDED') {
                    const remainingTime = res.data.remainingTime;
...
<<<<<<< HEAD
                      axios.patch(`http://172.16.9.33:5000/admin/unsuspendUser`, { email: userData.email }).then((res) => {
                        if (res.data.status === 'SUCCESS') {
                          axios.post("http://172.16.9.33:5000/user/loginOther", {email: userInfo.user.email }).then((res) => {
=======
                      axios.patch(`http://172.16.4.69:5000/admin/unsuspendUser`, { email: userData.email }).then((res) => {
                        if (res.data.status === 'SUCCESS') {
                          axios.post("http://172.16.4.69:5000/user/loginOther", {email: userInfo.user.email }).then((res) => {
>>>>>>> f23b0e0 (Homepage_v1)
                            console.log(res.data)
                            if (res.data.status === 'SUCCESS') {
                                Alert.alert('Success', 'You have successfully logged in.', [{ text: 'OK' }]);
...
=======
            const res = await axios.post("http://172.16.4.69:5000/user/getUserDetailsByEmail", userData);
>>>>>>> f23b0e0 (Homepage_v1)
...
<<<<<<< HEAD
        axios.post("http://172.16.9.33:5000/user/login", userData).then((res) => {
        const storedData = res.data.data;
        if (res.data.status === 'SUCCESS') {
          axios.get(`http://172.16.9.33:5000/admin/checkSuspensionStatus/${email}`).then((res) => {
=======
        axios.post("http://172.16.4.69:5000/user/login", userData).then((res) => {
        const storedData = res.data.data;
        if (res.data.status === 'SUCCESS') {
          axios.get(`http://172.16.4.69:5000/admin/checkSuspensionStatus/${email}`).then((res) => {
>>>>>>> f23b0e0 (Homepage_v1)
            if (res.data.status === 'SUCCESS') {
              if (res.data.type === 'SUSPENDED') {
                const remainingTime = res.data.remainingTime;
