...
export default function MobileLogin({navigation}) {
    ...
    const confirmCode = async () => {
        try {
            ...
            await axios.post("http://172.16.1.176:5000/user/loginUsingMobile", { mobile: mobile }).then(async (res) => {
    ...
    const checkIfMobileExists = async (mobile) => {
        try {
            const response = await axios.post("http://172.16.1.176:5000/user/getActualUserDetailsByMobile", { mobile });
