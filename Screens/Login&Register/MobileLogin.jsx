...
export default function MobileLogin({navigation}) {
    ...
    const confirmCode = async () => {
        try {
            ...
            await axios.post("http://192.168.1.9:5000/user/loginUsingMobile", { mobile: mobile }).then((res) => {
    ...
    const checkIfMobileExists = async (mobile) => {
        try {
            const response = await axios.post("http://192.168.1.9:5000/user/getActualUserDetailsByMobile", { mobile });
