...
export default function ForgotPasswordScreen({navigation}) {
    ...
    const handlePress = async () => {
        try {
            const response = await axios.post("http://192.168.1.9:5000/forgot_password_otp/request", { email: email });
    ...
    const fetchServerTime = async () => {
        try {
            ...
            const response = await axios.get(`http://192.168.1.9:5000/forgot_password_otp/getRemainingCurrentTime/${email}`);
    ...
    const handleSendAgainPress = () => {
        ...
        axios.post("http://192.168.1.9:5000/forgot_password_otp/request", userData).then((res) => {
    ...
    const confirmCode = async () => {
        ...
        axios.post("http://192.168.1.9:5000/forgot_password_otp/reset", userData).then((res) => {
