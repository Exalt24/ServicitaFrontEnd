    ...
    const confirmCode = async () => {
        ...
        try {
            ...
            if (res.data.status === 'SUCCESS') {
                ...
                await axios.post("http://192.168.1.7:5000/email_verification_otp/sendConfirmationEmail"), {email: email, name: `${storeData.data.name.firstName} ${storeData.data.name.lastName}`, role: storeData.data.role};
