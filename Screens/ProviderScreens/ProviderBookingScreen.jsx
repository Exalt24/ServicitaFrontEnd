...
export default function ProviderBookingScreen({ navigation, route }) {
  ...
  const getUserIdAndImage = async () => {
    try {
      const result = await axios.post("http://192.168.254.111:5000/user/getUserDetailsByEmail", { email: userEmail })
  ...
  async function getBookingData() {
    try {
        ...
        for (const doc of snapshot.docs) {
            ...
            const result = await axios.post("http://192.168.254.111:5000/user/getUserDetailsById", { id: seekerSnapshot.id })
