...
const [selectedDayIndex, setSelectedDayIndex] = useState(null);
  ...
  async function getUserId() {
    try {
      const result = await axios.post("http://192.168.1.9:5000/user/getUserDetailsByEmail", { email: userEmail })
  ...
  const fetchServices = async () => {
    try {
        const response = await axios.get('http://192.168.1.9:5000/service/getServices');
    ...
    <View style={{ marginHorizontal: width * 0.05, marginBottom: height * 0.01 }}>
      ...
      <View style={{ marginHorizontal: width * 0.05, marginBottom: height * 0.01 }}>
                        ...
                        <View style={{
                            ...
                            <FontAwesome5 name="map-marker-alt" color = {serviceName === null || serviceName === '' ? Color.colorBlue1 : serviceNameVerify ? Color.colorGreen : Color.colorRed} style={{ marginLeft: width * 0.07,fontSize: 24}}/>
                            <TextInput
