...
export const sendPushNotification = async (expoPushToken, title, body, userId, otherUserId) => {
  ...
  const result = await axios.post("http://172.16.1.176:5000/notifications/create", notification)
  return result;
};
...
const NotificationScreen = ({navigation}) => {
    ...
    const deleteNotification = async (notificationId) => {
      try {
        await axios.delete(`http://172.16.1.176:5000/notifications/deleteNotification`, { notificationId });
    ...
    useEffect(() => {
      const fetchNotifications = async () => {
        try {
          ...
          const response = await axios.get(`http://172.16.1.176:5000/notifications/getNotifications/${userId}`);
