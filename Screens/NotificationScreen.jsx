...
export const sendPushNotification = async (expoPushToken, title, body, userId) => {
  ...
  const result = await axios.post("http://192.168.1.2:5000/notifications/create", notification)
  return result;
};
    ...
    useEffect(() => {
      const fetchNotifications = async () => {
        try {
          ...
          const response = await axios.get(`http://192.168.1.2:5000/notifications/getNotifications/${userId}`);
          setNotifications(
